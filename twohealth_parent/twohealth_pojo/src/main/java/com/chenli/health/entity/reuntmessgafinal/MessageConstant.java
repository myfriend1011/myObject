package com.chenli.health.entity.reuntmessgafinal;
...
public class MessageConstant {
    ...
    public static final String CHECKGROUP_GUANNIAN_CHECKITEM="检查组关联检查项不能删除";
    public static final String SETMEAL_CHECKGROUP_GUANNINA="套餐关联检查组不能删除";

    public static final String ORDERSETTING_NUMBER_MIN = "设置预约人数不能小于已经预约人数";
}
