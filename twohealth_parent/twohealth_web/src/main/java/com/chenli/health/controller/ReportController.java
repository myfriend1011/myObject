...
import com.chenli.health.serviceinterface.ReportService;
...
public class ReportController {
    ...
    @Reference
    private MemberService memberService;//会员直线图
    @Reference
    private SetMealService setMealService;//会员套餐
    @Reference
    ...
    public Result getMemberReport(){
        ...
        List<Integer> memberCount = memberService.find_memberCountByMonth(list);
